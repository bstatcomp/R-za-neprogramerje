...
- Iz datumov nakupov izvlečite dan nakupa, nato poglejte kako se spreminja število nakupov glede na dan v tednu (*Hint: poglete funkcijo "table"*). Spomnitese, da morate najprej R-ju povedat, da je "date" stolpec datumov.
