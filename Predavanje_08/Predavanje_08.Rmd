...
Včasih želimo rezultate statističnega testa prikazati kar na grafu. Poglejmo si sedaj primer t-testa v ggplot2. Za to bomo potrebovali še en paket **ggpubr** in funkcijo iz tega paketa `stat_compare_means`.
...
Če želimo, lahko vso x os še uredimo v skladu z uro začetka vzorčenja, pri čemer uporabimo podatek shranjen v spremenljivkah `timestamp_A` in `timestamp_B` (v našem primeru je bil začetek enak, zato tega nismo rabili spreminjati).
