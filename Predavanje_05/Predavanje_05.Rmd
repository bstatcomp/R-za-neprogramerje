...
ggplot(df, aes(x = Datum, y = PM10)) + 
  ...
  geom_point(data = df, aes(colour = weekdays(Datum) == "Saturday" | weekdays(Datum) == "Sunday")) +
  ggtitle("Vrednosti meritev PM10 za tri slovenska mesta. Rdeča črta predstavlja kritično mejo dnevne onesnaženosti.") +
